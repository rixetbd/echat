...
<head>
    ...
    <meta charset="utf-8">
    <title>E-Chat - Web Application</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Responsive Bootstrap 4 Chat App" name="description">
    <meta content="Themesbrand" name="author">
    <!-- App favicon -->
    <link rel="shortcut icon" href="{{asset('assets/chat')}}/favicon.ico">

    <!-- magnific-popup css -->
    <link href="{{asset('assets/chat/css')}}/magnific-popup.css" rel="stylesheet" type="text/css">

    <!-- owl.carousel css -->
    <link rel="stylesheet" href="{{asset('assets/chat/css')}}/owl.carousel.min.css">

    <link rel="stylesheet" href="{{asset('assets/chat/css')}}/owl.theme.default.min.css">
    ...
    <div class="layout-wrapper d-lg-flex">
        ...
        <div class="side-menu flex-lg-column me-lg-1 ms-lg-0">
            ...
            <div class="navbar-brand-box">
                <a href="{{route('chat.index')}}" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{asset('assets/chat')}}/fonts/logo.svg" alt="" height="30">
                    </span>
                </a>

                <a href="{{route('chat.index')}}" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="{{asset('assets/chat')}}/fonts/logo.svg" alt="" height="30">
                    </span>
                </a>
                ...
                <ul class="nav nav-pills side-menu-nav justify-content-center" role="tablist">
                    ...
                    <li class="nav-item dropdown profile-user-dropdown d-inline-block d-lg-none">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                            ...
                            <img src="{{asset('assets/chat/images')}}/avatar-1.jpg" alt=""
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault();
                                ...
                                {{ __('Logout') }} <i class="ri-logout-circle-r-line float-end text-muted"></i>
                            </a>
        ...
        <div class="chat-leftsidebar me-lg-1 ms-lg-0">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="pills-user" role="tabpanel" aria-labelledby="pills-user-tab">
                    ...
                    <div>
                        ...
                        <div class="text-center p-4 border-bottom">
                            <div class="mb-4">
                                <img src="{{asset('assets/chat/images')}}/avatar-1.jpg"
                                ...
                                <div class="card accordion-item border">
                                    <div class="accordion-header" id="attachfile2">
                                        <button class="accordion-button collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#attachfile" aria-expanded="false"
                ...
                <div class="tab-pane fade show active" id="pills-chat" role="tabpanel" aria-labelledby="pills-chat-tab">
                    ...
                    <div>
                        <div class="px-4 pt-4">
                            <h4 class="mb-4">Chats - {{Auth::user()->name}}</h4>
                        ...
                        <div class="px-4 pb-4" dir="ltr">
                            ...
                            <div class="owl-carousel owl-theme" id="user-status-carousel">
                                <div class="item">
                                    <a href="#" class="user-status-box">
                                        <div class="avatar-xs mx-auto d-block chat-user-img online">
                                            <img src="{{asset('assets/chat/images')}}/avatar-2.jpg" alt="user-img"
                                ...
                                <div class="item">
                                    <a href="#" class="user-status-box">
                                        <div class="avatar-xs mx-auto d-block chat-user-img online">
                                            <img src="{{asset('assets/chat/images')}}/avatar-4.jpg" alt="user-img"
                                                class="img-fluid rounded-circle">
                                            <span class="user-status"></span>
                                        </div>
                                ...
                                <div class="item">
                                    <a href="#" class="user-status-box">
                                        <div class="avatar-xs mx-auto d-block chat-user-img online">
                                            <img src="{{asset('assets/chat/images')}}/avatar-5.jpg" alt="user-img"
                                                class="img-fluid rounded-circle">
                                            <span class="user-status"></span>
                                        </div>
                                ...
                                <div class="item">
                                    <a href="#" class="user-status-box">
                                        <div class="avatar-xs mx-auto d-block chat-user-img online">
                                            <img src="{{asset('assets/chat/images')}}/avatar-6.jpg" alt="user-img"
                                                class="img-fluid rounded-circle">
                                            <span class="user-status"></span>
                                        </div>
                                ...
                                <ul class="list-unstyled chat-list chat-user-list">
                                        ...
                                        <a href="#">
                                            <div class="d-flex">
                                                <div class="chat-user-img online align-self-center me-3 ms-0">
                                                    <img src="{{asset('assets/chat/images')}}/avatar-2.jpg"
                                        ...
                                        <a href="#">
                                            <div class="d-flex">
                                                <div class="chat-user-img away align-self-center me-3 ms-0">
                                                    <img src="{{asset('assets/chat/images')}}/avatar-3.jpg"
                                                        class="rounded-circle avatar-xs" alt="">
                                                    <span class="user-status"></span>
                                                </div>
                                                <div class="flex-grow-1 overflow-hidden">
                                    ...
                                    <li class="active">
                                        <a href="#">
                                            <div class="d-flex">
                                                <div class="chat-user-img online align-self-center me-3 ms-0">
                                                    <img src="{{asset('assets/chat/images')}}/avatar-4.jpg"
                                                        class="rounded-circle avatar-xs" alt="">
                                                    <span class="user-status"></span>
                                                </div>
                                                <div class="flex-grow-1 overflow-hidden">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="d-flex">
                                                <div class="chat-user-img away align-self-center me-3 ms-0">
                                                    <img src="{{asset('assets/chat/images')}}/avatar-6.jpg"
                                                        class="rounded-circle avatar-xs" alt="">
                                                    <span class="user-status"></span>
                                                </div>
                                                <div class="flex-grow-1 overflow-hidden">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="d-flex">
                                                <div class="chat-user-img away align-self-center me-3 ms-0">
                                                    <img src="{{asset('assets/chat/images')}}/avatar-7.jpg"
                                                        class="rounded-circle avatar-xs" alt="">
                                                    <span class="user-status"></span>
                                                </div>
                                                <div class="flex-grow-1 overflow-hidden">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="d-flex">
                                                <div class="chat-user-img away align-self-center me-3 ms-0">
                                                    <img src="{{asset('assets/chat/images')}}/avatar-8.jpg"
                                                        class="rounded-circle avatar-xs" alt="">
                                                    <span class="user-status"></span>
                                                </div>
                                                <div class="flex-grow-1 overflow-hidden">
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body p-4">
                                            <form method="POST" action="SaveWeb2zip-order.php">
                                                <div class="mb-4">
                        ...
                        <div class="modal-body">
                            <div class="text-center p-4">
                                <div class="avatar-lg mx-auto mb-4">
                                    <img src="{{asset('assets/chat/images')}}/avatar-4.jpg" alt=""
        ...
        <!-- JAVASCRIPT -->
        <script src="{{asset('assets/chat/js')}}/jquery.min.js"></script>
        <script src="{{asset('assets/chat/js')}}/bootstrap.bundle.min.js"></script>
        <script src="{{asset('assets/chat/js')}}/simplebar.min.js"></script>
        <script src="{{asset('assets/chat/js')}}/waves.min.js"></script>

        <!-- Magnific Popup-->
        <script src="{{asset('assets/chat/js')}}/jquery.magnific-popup.min.js"></script>

        <!-- owl.carousel js -->
        <script src="{{asset('assets/chat/js')}}/owl.carousel.min.js"></script>

        <!-- page init -->
        <script src="{{asset('assets/chat/js')}}/index.init.js"></script>
